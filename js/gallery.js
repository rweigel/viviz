function gallery(wrapper) {
	...
	if (location.hash != "") {
		...
		console.log("gallery.js: Hash is not empty.")
    ...
    function settabledims(tw,th) {
        ...
        if ($(wrapper + " #fullframe img").eq(0).height() > 0) {
        		console.log("gallery.settabledims(): Setting thumb frame height to be height of full image + 10 = "+($(wrapper + " #fullframe img").eq(0).height()+10));
            $(wrapper + " #gallerythumbframe").height($(wrapper + " #fullframe img").eq(0).height());
            $(wrapper + " #fullframe").height($(wrapper + " #fullframe img").eq(0).height()+10);
        } else {
            if ($('#gallerythumbframe img').eq(0).height() > 0) {
            		var a = 4*$('#gallerythumbframe img').eq(0).height()+10;
				console.log("yyy Setting thumb frame height to be 4*thumbheight+10px = "+a);
				console.log("First thumbnail height = " + $('#gallerythumbframe img').eq(0).height());
		...
		$("#fullframe").css('margin-left',tw+35);
...
//return;
		...
		console.log("dh = " + dh);
		if (typeof(settabledims.ho) !== "undefined") {
			console.log("1111111 " + $(wrapper + " #fullframe img").length);	
			//setTimeout(function () {$(".full").css('height',settabledims.ho)},1000);
		}
		if (dh > 0 || dw > 0) {
			if (dh > 0 && dw <= 0) {
				console.log("777777 Adjusting height by "+dh);
			...
			if (dh < 0 && dw > 0) {
				console.log("888888 Need to adjust width only");
			}
			if (dh > 0 && dw > 0) {
				console.log("999999 Need to adjust width only");
			}
	...
	function loadfull(jq) {
        ...
        $(wrapper + " #fullframe img[id="+id+"]")
	        	...
	        	.load(function(){
		        	...
		        	if (typeof(settabledims.ho) !== "undefined") {
				//console.log("1111111 " + $(wrapper + " #fullframe img").length);	
				//$(this).css('height',settabledims.ho);
				}
    ...
    function setthumb(INFOjs,i,allbad) {
        ...
        function firstimage(f) {
				...
				.load(function () {
					...
					INFOjs[f].Width  = this.naturalWidth;//$(this).width();
					INFOjs[f].Height = $(this).height();
					console.log('gallery.firstimage(): First thumbnail loaded with width = '+INFOjs[f].Width+'. Setting table dimensions.');
					settabledims(INFOjs[f].Width,$(this).height());
