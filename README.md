...
The directory [http://sohowww.nascom.nasa.gov/data/synoptic/sunspots_earth/](http://sohowww.nascom.nasa.gov/data/synoptic/sunspots_earth/) contains image files with a pattern that can be represented by a [http://tsds.org/uri_templates_v1](template]) `sunspots_512_$Y$m$d.jpg`. Browse them using ViViz using the link
